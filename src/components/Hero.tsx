  ...
  return (
    <section className="container mx-auto px-4 pt-10 pb-6 sm:pt-16 sm:pb-10">
      <div className="max-w-3xl mx-auto text-center">
        <span className="inline-block bg-[#1B4332]/5 text-[#1B4332] text-xs font-semibold tracking-wider uppercase rounded-full px-4 py-1.5 mb-6 border border-[#1B4332]/10">
